...
import heroImg from "../images/path3962.png"
import gridLines from "../images/grid-lines.svg"


const Hero = () => (
<div className="text-black h-auto py-12" id="hero-bg">
...
<div>  
  <div className="mx-auto max-w-screen-lg py-32 sm:py-48 lg:py-32">
            <div className="text-center">
              <h1 className="text-display-4xl font-bold tracking-tight text-black sm:text-6xl">Enrich Your Customer Experience with us</h1>
              <p className="mt-6 text-body-md leading-8 text-gray-400">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.</p>
