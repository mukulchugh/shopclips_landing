            ...
            <div className="md:max-w-4xl mx-auto">
              ...
              <div className="mb-11 flex flex-wrap -m-1">
                <div className="w-full p-1">
                    <div className="cursor-pointer py-7 px-8 bg-white bg-opacity-60 border-2 border-indigo-600 rounded-2xl shadow-10xl">
                      <div className="flex flex-wrap justify-between -m-2">
                        ...
                        <div className="w-auto p-2">
                          <svg className="relative top-1" width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4.16732 12.5L10.0007 6.66667L15.834 12.5" stroke="#4F46E5" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                          </svg>
                        </div>
                      </div>
                    </div>
                ...
                <Disclosure key={"1"} defaultOpen={true} as="div" className="w-full p-1">
                    <Disclosure.Button as="div" className="py-7 px-8 bg-white bg-opacity-60 border border-gray-200 hover:border-gray-300 rounded-2xl shadow-10xl">
                      <div className="flex flex-wrap justify-between -m-2">
                        <div className="flex-1 p-2">
